...
void LitColumnsApp::UpdateMainPassCB(const GameTimer& gt)
{
	...
	//mMainPassCB.Lights[0].Strength = { 0.6f, 0.6f, 0.6f }; // Original
	mMainPassCB.Lights[0].Strength = { 0.6f, 0.0f, 0.0f };
	mMainPassCB.Lights[1].Direction = { -0.57735f, -0.57735f, 0.57735f };
	//mMainPassCB.Lights[1].Strength = { 0.3f, 0.3f, 0.3f }; // Original
	mMainPassCB.Lights[1].Strength = { 0.3f, 0.0f, 0.0f };
	mMainPassCB.Lights[2].Direction = { 0.0f, -0.707f, -0.707f };
	mMainPassCB.Lights[2].Strength = { 0.15f, 0.15f, 0.15f }; // Original
	//mMainPassCB.Lights[2].Strength = { 0.15f, 0.0f, 0.0f };
...
void LitColumnsApp::BuildMaterials()
{
	...
	//bricks0->Roughness = 0.1f; // Original
	...
	//stone0->Roughness = 0.3f; // Original
	stone0->Roughness = 0.0f;
	...
	//skullMat->Roughness = 0.3f; // Original
